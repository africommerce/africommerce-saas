...
import classes from './WholeSaleCreate.module.css';

const WholeSaleCreate = () => {
  ...
  return (
    <div className={classes.container} onClick={() => setSelectOptions(false)}>
      <div className={classes.head_wrapper}> Add new wholesale product</div>
...
export default WholeSaleCreate;
