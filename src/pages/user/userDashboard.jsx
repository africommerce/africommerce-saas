          ...
          <Case>
            <Card2>
              <div style={{ borderBottom: "1px solid #ebedf2"}}>
                <h5 style={{fontWeight: "500", lineHeight: "1.2", padding:"1rem"}}>Default Shipping Address</h5></div>
              <Base style={{marginTop: "1rem", marginBottom: "1rem"}}>
                <p style={{padding: "0 1rem"}}>Address: 3947 West Side Avenue Hackensack, NJ 07601</p>
            ...
            <Card2>
              <div style={{ borderBottom: "1px solid #ebedf2"}}>
                <h5 style={{fontWeight: "500", lineHeight: "1.2", padding:"1rem"}}>Purchased Package</h5></div>
              <Base>
                <img src="" />
                <p style={{padding: "0 1rem"}}>Product Upload: 300times</p>
                <p style={{padding: "0 1rem"}}>Product Upload Remaining: 594 times</p>
                <h5 style={{padding: "0 1rem", color: "red", fontWeight:"800"}}>Current Package: Premium</h5>
                <p style={{padding: "0 1rem"}}><Button>Upgrade Package</Button></p>
              </Base>
            </Card2>
          </Case>
        </Cases>
