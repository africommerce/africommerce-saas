  ...
  return (
    <Container>
      ...
      <Section2>
        ...
        <P2>Our Privacy Policy was last updated on [DATE].</P2>
        <P2>
        ...
        <P3>Interpretation and Definitions</P3>
        ...
        <P1>Collecting and Using Your Personal Data</P1>
        <P3>Types of Data Collected</P3>
        <P2>Personal Data</P2>
        <P2>
        ...
        <P2>Email address</P2>
        <P2>First name and last name</P2>
        <P2>Phone number</P2>
        <P2>Address, State, Province, ZIP/Postal code, City</P2>
        <P2>Usage Data</P2>
        <P2>Usage Data</P2>
        <P2>Usage Data is collected automatically when using the Service.</P2>
        <P2>
        ...
        <P2>Tracking Technologies and Cookies</P2>
        <P2>
        ...
        <P2>"Necessary / Essential Cookies"</P2>
        <P2>"Type: Session Cookies"</P2>
        <P2>"Administered by: Us"</P2>
        <P2>
        ...
        <P3>"Cookies Policy / Notice Acceptance Cookies"</P3>
        <P2>"Type: Persistent Cookies"</P2>
        <P2>"Administered by: Us"</P2>
        <P2>
          "Purpose: These Cookies identify if users have accepted the use of
          cookies on the Website."{' '}
        </P2>
        <P3>"Functionality Cookies" </P3>
        <P2>"Type: Persistent Cookies"</P2>
        <P2>"Administered by: Us"</P2>
        <P2>
        ...
        <P3>"Tracking and Performance Cookies" </P3>
        <P2>"Type: Persistent Cookies"</P2>
        <P2>"Administered by: Us"</P2>
        <P2>
        ...
        <P1>Use of Your Personal Data</P1>
        <P2>The Company may use Personal Data for the following purposes:</P2>
        <P2>
        ...
        <P1>Retention of Your Personal Data</P1>
        <P2>
        ...
        <P1>Transfer of Your Personal Data</P1>
        <P2>
        ...
        <P1>Disclosure of Your Personal Data</P1>
        <P1>Business Transactions</P1>
        <P2>
        ...
        <P1>Law enforcement</P1>
        <P2>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </P2>
        <P3>Other legal requirements</P3>
        <P2>
          The Company may disclose Your Personal Data in the good faith belief
          that such action is necessary to:
        </P2>
        <P2>Comply with a legal obligation</P2>
        <P2>Protect and defend the rights or property of the Company</P2>
        <P2>
        ...
        <P3>Detailed Information on the Processing of Your Personal Data</P3>
        <P2>
        ...
        <P1>Changes to this Privacy Policy</P1>
        <P2>
